...
import DataAccessObjects.FoodFile;
...
public class TextUserInterface {
    ...
    */
    public void run(){
        ...
        while (!command.equals("exit")){
            command = userMenuCommandFile();
        }
    }
    
    /*
    USER MENU COMMAND FILE
    */
    public String userMenuCommandFile(){
        ...
        switch (userCommand){
            ...
            default:
                ...
                return this.userMenuCommandFile();
        }   
    ...
    */
    public boolean sortFoods(){
        String criteria = sortFoodsInputCriteria();
        
        if (criteria == null){
            return false;
        }
        
        String order = sortFoodsInputOrder();
        if (order == null){
            return false;
        }
        ...
        Stat stat = convertStringToStat(criteria);
    ...
    /*
    SORT FOODS INPUT ORDER
    */
    public String sortFoodsInputOrder(){
        String order = "";
